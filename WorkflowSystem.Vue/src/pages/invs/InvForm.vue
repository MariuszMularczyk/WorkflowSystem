        ...
        <div class="row">
          <div class="col">
            <label class="form-label"
              >Wykryto anomalię cenową, sprawdź ponownie ten zakup</label
            >
          </div>
        </div>
      </div>
      ...
      <form>
        <DxValidationGroup :ref="groupRefKey">
          <div class="primary-border">
            ...
            <div class="row">
              <div class="col-6">
                <label for="clientNameTextBox" class="form-label"
                  >Kontrahent</label
                >
                <DxTextBox
                  v-model="ClientName"
                  id="clientNameTextBox"
              ...
              <div class="col">
                <label for="introductionDateDateBox" class="form-label"
                  >Data wprowadzenia</label
                >
                <DxDateBox
                  v-model="IntroductionDate"
            ...
            <div class="row mt-4">
              <div class="col-6">
                <label for="FvNumberTextBox" class="form-label"
                  >Numer faktury</label
                >
                <DxTextBox
                  v-model="FvNumber"
              ...
              <div class="col">
                <label for="peoplesSelectBox" class="form-label"
                  >Osoba wprowadzająca</label
                >
                <DxSelectBox
                  :dataSource="users"
                  value-expr="value"
              ...
              <div class="col">
                <label for="peoples2SelectBox" class="form-label"
                  >Osoba merytoryczna</label
                >
                <DxSelectBox
                  :dataSource="users"
                  value-expr="value"
                ...
                >
                  <DxValidator>
                    <DxRequiredRule
                      message="Osoba merytoryczna jest wymagana!"
                    />
                  </DxValidator>
                </DxSelectBox>
              </div>
            ...
            <div class="row mt-4">
              <div class="col">
                <label for="dateOfReceiptDateBox" class="form-label"
                  >Data wpływu</label
                >
                <DxDateBox
              ...
              <div class="col">
                <label for="dateOfIssueDateBox" class="form-label"
              ...
              <div class="col">
                <label for="saleDateDateBox" class="form-label"
              ...
              <div class="col">
                <label for="dateOfPaymentDateBox" class="form-label"
                  >Data płatności</label
                >
                <DxDateBox
            ...
            <div class="row mt-4">
              ...
              <div class="col">
                <label for="paymentTypeSelectBox" class="form-label"
              ...
              <div class="col">
                <label for="fvTypesSelectBox" class="form-label"
                  >Typ faktury</label
                >
                <DxSelectBox
                  :dataSource="fvTypes"
            ...
            <div class="row mt-4">
              ...
              <div class="col">
                <label for="paymentStatusSelectBox" class="form-label"
            ...
            <DxButton
              text="Dodaj"
              @click="showAddPositionPopup()"
              class="ml-1 mt-4"
              v-if="buttonAddVisible"
              :read-only="isReadOnly"
            />

            <RecordAdd
              v-if="addPositionPopupOptions.isVisible"
              :parentInv="getInvId"
              @close="onPositionPopupClose"
            />

            <RecordEdit
              v-if="detailsPositionPopupOptions.isVisible"
              ...
              <template #actions-template="{ data }">
                <div style="display: flex; justify-content: center">
                  ...
                  <div v-if="buttonAddVisible">
                    ...
                    >
                      <i class="fas fa-trash grid-icon ml-2"></i>
                    </a>
                  </div>
                </div>
              </template>
...
export default {
  ...
  computed: {
    ...
    buttonVisible() {
      ...
      } else if (this.getStep == 3 || this.getStep == 4 || this.getStep == 5) {
