...
export default {
  ...
  computed: {
    ...mapGetters({
      getPlayers: "users/getPlayers",
    }),
  },
  methods: {
    ...mapActions({
      setUsersAdmin: "users/setUsersAdmin",
      setUserTypesToLookup: "users/setUserTypesToLookup",
      banUserAdmin: "users/banUserAdmin",
      unbanUserAdmin: "users/unbanUserAdmin",
      userImageDeleteAdmin: "users/userImageDeleteAdmin",
    }),
    ...mapMutations({
      RESET_PLAYERS: "users/RESET_PLAYERS",
    }),
    onUserBan(data) {
